...
W przypadku wysy�ania nowych wyda� na serwer za pomoc� SSH powiniene� u�ywa� kluczy.
Prosta instrukcja jak je generowa� jest tutaj: https://wiki.mikr.us/uzywaj_kluczy_ssh/

Kr�tko o projekcie
========

Chcia�bym, aby ten projekt by� zbiorem dobrych praktyk, kt�rych chc� u�ywa�, za ka�dym razem, gdy zaczynam nowy program. 

Inne ciekawe szablony
========

Tutaj prezentuj� list� szablon�w, kt�re r�wnie� warto rozwa�y� przy zaczynaniu nowych projekt�w:

- https://github.com/Dotnet-Boxed/Templates/ - w tym projekcie s� fajnie rozwini�te projekty aplikacji serwerowych (API, GraphQL, Orleans)

- https://github.com/dotnet/templating/wiki/Available-templates-for-dotnet-new - lista r�nych projekt�w z szablonami
